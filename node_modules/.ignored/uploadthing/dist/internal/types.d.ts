...
import type { FileRouterInputConfig, UploadedFile, UploadThingError } from "@uploadthing/shared";
...
export type RequestLike = Overwrite<WithRequired<Partial<Request>, "json">, {
...
export declare const VALID_ACTION_TYPES: readonly ["upload", "failure"];

...
import type { Clerk, ClerkOptions, ClientResource, DomainOrProxyUrl, LoadedClerk, MultiDomainAndOrProxy, PublishableKeyOrFrontendApi, SessionResource, SignInRedirectOptions, SignUpRedirectOptions, UserResource } from '@clerk/types';
declare global {
    interface Window {

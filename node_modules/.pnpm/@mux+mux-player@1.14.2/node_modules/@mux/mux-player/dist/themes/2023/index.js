  ...
  <template partial="RenditionSelect">
    <media-rendition-selectmenu part="bottom rendition selectmenu" disabled="{{disabled}}" aria-disabled="{{disabled}}">
      <media-rendition-button slot="button" part="bottom rendition button">
        <svg slot="icon" viewBox="0 0 18 14">
          <path
            d="M2.25 8.92041C3.35457 8.92041 4.25 8.02498 4.25 6.92041C4.25 5.81584 3.35457 4.92041 2.25 4.92041C1.14543 4.92041 0.25 5.81584 0.25 6.92041C0.25 8.02498 1.14543 8.92041 2.25 8.92041Z"
          />
          <path
            d="M9 8.92041C10.1046 8.92041 11 8.02498 11 6.92041C11 5.81584 10.1046 4.92041 9 4.92041C7.89543 4.92041 7 5.81584 7 6.92041C7 8.02498 7.89543 8.92041 9 8.92041Z"
          />
          <path
            d="M15.75 8.92041C16.8546 8.92041 17.75 8.02498 17.75 6.92041C17.75 5.81584 16.8546 4.92041 15.75 4.92041C14.6454 4.92041 13.75 5.81584 13.75 6.92041C13.75 8.02498 14.6454 8.92041 15.75 8.92041Z"
          />
        </svg>
      </media-rendition-button>
      <media-rendition-listbox slot="listbox" part="listbox">
        <div slot="select-indicator">
          <style>
            .listbox-indicator {
              position: relative;

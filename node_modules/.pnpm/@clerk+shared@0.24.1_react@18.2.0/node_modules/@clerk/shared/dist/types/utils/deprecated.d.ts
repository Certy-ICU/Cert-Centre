export declare const deprecated: (fnName: string, warning: string, key?: string) => void;
/**
...
export declare const deprecatedProperty: (cls: AnyClass, propName: string, warning: string, isStatic?: boolean) => void;
/**
 ...
 */
export declare const deprecatedObjectProperty: (obj: Record<string, any>, propName: string, warning: string) => void;
export {};

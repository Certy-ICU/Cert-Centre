...
export declare const mergeNextClerkPropsWithEnv: (props: Omit<NextClerkProviderProps, 'children'>) => {
    ...
    appearance?: import("@clerk/types").Appearance<import("@clerk/types").Theme> | undefined;

...
export namespace MediaUIStates {
    ...
    namespace MEDIA_SUBTITLES_LIST {
        export function get_25(controller: any): {
            kind: TextTrackKind;
            label: string;
            language: string;
        }[];
    ...
    namespace MEDIA_RENDITION_LIST {
        export function get_27(controller: any): any[];
    ...
    namespace MEDIA_AUDIO_TRACK_LIST {
        ...
        const mediaEvents_27: string[];
        export { mediaEvents_27 as mediaEvents };
    ...
    namespace MEDIA_AUDIO_TRACK_ENABLED {
        ...
        const mediaEvents_28: string[];
        export { mediaEvents_28 as mediaEvents };
...
export namespace MediaUIRequestHandlers {
    ...
    function MEDIA_SHOW_SUBTITLES_REQUEST(media: any, event: any, controller: any): void;
    function MEDIA_DISABLE_SUBTITLES_REQUEST(media: any, event: any, controller: any): void;
